...
<body>
  ...
  <div class="grid">
    ...
    <button data-command="sbomTool.openLatestSbomReport" class="secondary">${escape(state.labels.dashboardOpenLatestSbomReport)}</button>
    <button data-command="sbomTool.openLatestVulnerabilityReport" class="secondary">${escape(state.labels.dashboardOpenLatestVulnerabilityReport)}</button>
    <button data-command="sbomTool.openLatestSbomJson" class="secondary">${escape(state.labels.dashboardOpenLatestSbomJson)}</button>
    <button data-command="sbomTool.openLatestVulnerabilityJson" class="secondary">${escape(state.labels.dashboardOpenLatestVulnerabilityJson)}</button>
    <button data-command="sbomTool.openOutputDirectory" class="secondary">${escape(state.labels.dashboardOpenOutputDirectory)}</button>
    <button data-command="sbomTool.cleanOldResults" class="secondary">${escape(state.labels.dashboardCleanOldResults)}</button>
